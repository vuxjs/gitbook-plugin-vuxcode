      ...
      process: function(block) {
        ...
        for(var i in data) {
          if (i==='template' && data[i]) {
            html +=`<p style="color:#ccc;margin-bottom:0;margin-top:10px;">template</p><pre style="margin:0;padding:0;"><code class="language-html">${addTag(data[i],'template')}</code></pre>`
          }
          if (i==='script' && data[i]) {
            html +=`<p style="color:#ccc;margin-bottom:0;margin-top:10px;">script</p><pre style="margin:0;padding:0;"><code class="language-javascript">${addTag(data[i],'script')}</code></pre>`
          }
          if (i==='style' && data[i]) {
            html +=`<p style="color:#ccc;margin-bottom:0;margin-top:10px;">style</p><pre style="margin:0;padding:0;"><code class="language-css">${addTag(data[i],'style')}</code></pre>`
          }
        }
        return html
      }
